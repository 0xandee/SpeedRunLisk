export const SEA_CAMPAIGN_METADATA = {
  ...
  "sea-week-3-indexing-display": {
    ...
    videoUrl: "V3 (10m): Index & display (init, entities, queries, paginate)",
  ...
  "sea-week-4-oracle-sponsored": {
    ...
    videoUrl: "V4 (10m): Oracles & sponsored UX (toggle sponsorship via env)",
  ...
  "sea-week-5-nft-badge-game": {
    ...
    videoUrl: "V5 (10m): Demo implementation NFT badge and mini-game + submission checklist",
