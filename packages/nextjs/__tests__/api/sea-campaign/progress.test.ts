...
const mockGetUserProgress =
  require("../../../services/database/repositories/seaCampaignProgress").getSeaCampaignProgress;
const mockGetUserSubmissions =
  require("../../../services/database/repositories/seaCampaignSubmissions").getSubmissionsByUser;
