...
describe('/api/sea-campaign/submit', () => {
  ...
  describe('POST', () => {
    ...
    it('should accept valid submission', async () => {
      ...
      const mockCreateSubmission = require('../../../services/database/repositories/seaCampaignSubmissions').createSeaCampaignSubmission;
      const mockUpdateProgress = require('../../../services/database/repositories/seaCampaignProgress').updateSeaCampaignProgress;
