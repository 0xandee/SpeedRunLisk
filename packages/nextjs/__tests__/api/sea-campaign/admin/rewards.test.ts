...
import { GET, POST } from "../../../../app/api/sea-campaign/admin/rewards/route";
...
const mockGetSubmissionsByWeek =
  require("../../../../services/database/repositories/seaCampaignSubmissions").getSubmissionsByWeek;
